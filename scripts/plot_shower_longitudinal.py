"""CLI: longitudinal shower profile for one electron."""
import argparse
...
def main():
    ...
    p.add_argument("--out", type=Path, default=Path("plots/shower_longitudinal.png"))
    args = p.parse_args()
    ...
    fig = plots.shower_longitudinal_profile(
        ...
        full_shower=not args.direct_only, n_bins=args.bins,
    )
